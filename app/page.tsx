  ...
  return (
    <>
      ...
      <section className="border-b border-line bg-paper">
        <div className="mx-auto grid w-full max-w-[1600px] items-center gap-12 px-6 py-16 lg:grid-cols-[1.05fr_1fr] lg:px-10 lg:py-24">
          <div>
            ...
            <h1 className="mt-4 font-[family-name:var(--font-display)] text-[52px] leading-[1.02] text-ink lg:text-[76px]">
            ...
            <p className="mt-6 max-w-xl text-[16px] leading-relaxed text-ink-soft">
              Choose a card, make it yours, add your guest list, and send. Kadi handles
            ...
            <div className="mt-9 flex flex-wrap items-center gap-3">
              <Link
                href="/templates"
                className="rounded-lg bg-sage px-6 py-3.5 text-[14px] font-medium text-ivory transition-colors hover:bg-sage-deep"
              >
                Browse templates
              </Link>
              <Link
                href="/studio"
                className="rounded-lg border border-line bg-paper px-6 py-3.5 text-[14px] text-ink-soft transition-colors hover:border-ink-faint hover:text-ink"
              >
                Open the studio
              </Link>
            </div>
            ...
            <dl className="mt-12 grid max-w-lg grid-cols-3 gap-6 border-t border-line pt-8">
              <Stat value={LAYOUTS.toLocaleString()} label="card layouts" />
      ...
      <section className="mx-auto w-full max-w-[1600px] px-6 py-20 lg:px-10">
        <h2 className="font-[family-name:var(--font-display)] text-[36px] leading-tight text-ink lg:text-[44px]">
        ...
        <div className="mt-10 grid gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5">
          {[
            ...
            <Link
              ...
              className="lift rounded-xl border border-line bg-paper p-6 transition-colors hover:border-ink-faint"
            >
              ...
              <span className="mt-4 inline-block text-[12.5px] text-sage">Browse →</span>
            </Link>
          ))}
        </div>
      </section>
      ...
      <section className="mx-auto w-full max-w-[1600px] px-6 py-24 text-center lg:px-10">
        <h2 className="font-[family-name:var(--font-display)] text-[40px] leading-tight text-ink lg:text-[54px]">
        ...
        <Link
          href="/templates"
          className="mt-8 inline-block rounded-lg bg-sage px-7 py-3.5 text-[14px] font-medium text-ivory transition-colors hover:bg-sage-deep"
        >
          Browse templates
        </Link>
      </section>
...
function Stat({ value, label }: { value: string; label: string }) {
  return (
    <div>
      <dt className="font-[family-name:var(--font-display)] text-[30px] leading-none text-ink">{value}</dt>
